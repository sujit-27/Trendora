...
const MobileAndAccessories = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        ...
        // Filter to allowed Mobile and accessory subcategories
  ...
  const filteredProducts = products
    .filter(product => {
      ...
      const categoryMatch = selectedCategory === 'All' || subcat === selectedCategory.toLowerCase();
  ...
  return (
    <div className="min-h-screen">
      {/* flex-col on mobile, flex-row on md and above */}
